...
import com.example.minor1.databinding.FragmentWizardvowBinding
import com.google.firebase.firestore.FirebaseFirestore
import models.profile.cateringsinglemodel
import recyclerviews.venueadapter
import recyclerviews.venueadapter2

class wizardvow : Fragment() {

    lateinit var binding: FragmentWizardvowBinding
    ...
    override fun onCreateView(
        ...
        binding= DataBindingUtil.inflate(inflater,R.layout.fragment_wizardvow,container,false)
