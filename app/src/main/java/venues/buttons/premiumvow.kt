...
import com.example.minor1.databinding.FragmentPremiumvowBinding
import com.google.firebase.firestore.FirebaseFirestore
import models.profile.cateringsinglemodel
import recyclerviews.venueadapter
import recyclerviews.venueadapter2

class premiumvow : Fragment() {

    lateinit var binding: FragmentPremiumvowBinding
    ...
    ): View? {  binding= DataBindingUtil.inflate(inflater,R.layout.fragment_premiumvow,container,false)
