...
import com.example.minor1.databinding.FragmentTownvowBinding
import com.google.firebase.firestore.FirebaseFirestore
import models.profile.cateringsinglemodel
import recyclerviews.venueadapter
import recyclerviews.venueadapter2

class townvow : Fragment() {

    lateinit var binding: FragmentTownvowBinding
    ...
    ): View? {  binding= DataBindingUtil.inflate(inflater,R.layout.fragment_townvow,container,false)
