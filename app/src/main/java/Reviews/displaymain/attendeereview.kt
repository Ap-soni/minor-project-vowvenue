...
import com.example.minor1.databinding.FragmentAttendeereviewBinding
import com.google.firebase.firestore.FirebaseFirestore
import models.datamodels.review3model
import recyclerviews.reviewrecyclerview

class attendeereview : Fragment() {

    private lateinit var firestore: FirebaseFirestore
    lateinit var binding: FragmentAttendeereviewBinding
    ...
    override fun onCreateView(
        ...
        binding= DataBindingUtil.inflate(inflater,R.layout.fragment_attendeereview,container,false)
