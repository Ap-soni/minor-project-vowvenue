...
import com.example.minor1.databinding.FragmentReviewproductBinding
...
class reviewproduct : Fragment() {
    ...
    override fun onCreateView(
        ...
        binding= DataBindingUtil.inflate(inflater,R.layout.fragment_reviewproduct,container,false)
        ...
        binding.imagereview.setOnClickListener {
            ...
            binding.submitbtn.setOnClickListener {
                ...
                viewModel.data.observe(viewLifecycleOwner) { value ->
                    ...
                    val storageReference= FirebaseStorage.getInstance().getReference().child("caterings images").child("${value.toString()}").child("image")
                    ...
                    storageReference.putFile(imageuri!!).addOnSuccessListener {
                        ...
                        storageReference.downloadUrl.addOnCompleteListener {uriTask->
                            ...
                            firestore.collection("reviewscaterings").add(review).addOnSuccessListener {
