...
import venues.buttons.venueonclick

class venueadapter2 (val cateringlist:ArrayList<cateringsinglemodel>):
    RecyclerView.Adapter<venueadapter2.myviewholder>() {
        ...
        init {
            ...
            itemview.setOnClickListener{
                ...
                fragmentManager.beginTransaction()
                    .replace(R.id.linearmainlayout, venueonclick())
